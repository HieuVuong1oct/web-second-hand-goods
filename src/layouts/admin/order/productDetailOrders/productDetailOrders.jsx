...
const ProductDetailOrders = () => {
  ...
  return (
    <>
      ...
      >
        <ComponentProductDetail imageBig={imageBig} smallImages={smallImages} product={product} />
      ...
      <Typography sx={{ cursor: 'pointer', color: 'blue', mt: 2 }} onClick={handleOrder}>
        Tới trang duyệt sản phẩm
      </Typography>
    </>
  );
};
