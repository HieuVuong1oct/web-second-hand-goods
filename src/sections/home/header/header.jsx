        ...
        <div className={classes.item1}>
          {isLoggedIn ? (
            ...
            <div className={classes.loginButtons}>
              <Button sx={{ color: '#9c27b0' }} className={classes.loginButton} onClick={handleLoginClick}>
                Đăng nhập
              </Button>
              <Button sx={{ color: '#9c27b0' }} className={classes.loginButton} onClick={handleRegisterClick}>
                Đăng ký
              </Button>
            </div>
          )}
